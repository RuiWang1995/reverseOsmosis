...
feed1 = Feed(1.09862, 298.15, 9.118, 42 / 3600, 0)
...
step1 = Steps(100, membrane1, pressureVessel1)
column1 = Column(pressureVessel1, 4)
column2 = Column(pressureVessel1, 2)
column3 = Column(pressureVessel1, 1)
