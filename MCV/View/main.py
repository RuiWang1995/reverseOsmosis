...
class CalScreen(Screen):
    def run(self, membraneName, membraneLength, membraneWidth, Aw_25, Bs_25, foulingFactor, feedSpacerThickness,
        ...
        self.displayPermeateFlowRateFromStage1.text = str(int(List[0][3]*3600 * 1000) / 1000)
        self.displayRetentateSoluteConcentrationFromStage1.text = str(int(List[0][6] * 1000) / 1000)
        self.displayRetentateFlowRateFromStage1.text = str(int(List[0][5]*3600 * 1000) / 1000)
        ...
        self.displayPermeateFlowRateFromStage2.text = str(int(List[1][3]*3600 * 1000) / 1000)
        self.displayRetentateSoluteConcentrationFromStage2.text = str(int(List[1][6] * 1000) / 1000)
        self.displayRetentateFlowRateFromStage2.text = str(int(List[1][5]*3600*1000) / 1000)
        ...
        if column3 is not None:
            ...
            self.displayPermeateFlowRateFromStage3.text = str(int(List[2][3] * 3600 * 1000) / 1000)
            self.displayRetentateSoluteConcentrationFromStage3.text = str(int(List[2][6] * 1000) / 1000)
            self.displayRetentateFlowRateFromStage3.text = str(int(List[2][5]*3600*1000) / 1000)
